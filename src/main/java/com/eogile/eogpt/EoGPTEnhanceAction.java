...
public class EoGPTEnhanceAction extends PsiElementBaseIntentionAction implements IntentionAction {

    @NotNull
    @Override
    public String getText() {
        return "eoGPT enhance";
    }
    ...
    public void invoke(@NotNull Project project, Editor editor, @NotNull PsiElement element) throws IncorrectOperationException {
        ...
        ProgressManager.getInstance().run(new Task.Backgroundable(project, "eoGPT enhance", false) {
            @Override
            public void run(@NotNull ProgressIndicator indicator) {
                var result = EoGPTManager.instance().queryEnhance(text, methodName, userInput);
