...
public class EoGPTExplainAction extends PsiElementBaseIntentionAction implements IntentionAction {

    @NotNull
    @Override
    public String getText() {
        return "eoGPT explain";
    }
    ...
    public void invoke(@NotNull Project project, Editor editor, @NotNull PsiElement element) throws IncorrectOperationException {
        ...
        ProgressManager.getInstance().run(new Task.Backgroundable(project, "eoGPT explain", false) {
            @Override
            public void run(@NotNull ProgressIndicator indicator) {
                var result = EoGPTManager.instance().queryExplain(text, userInput);
